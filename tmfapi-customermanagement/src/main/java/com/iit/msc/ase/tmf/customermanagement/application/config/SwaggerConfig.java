package com.iit.msc.ase.tmf.customermanagement.application.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select().apis(RequestHandlerSelectors.basePackage("com.iit.msc.ase.tmf.customermanagement.application.controller"))
                .paths(regex("/.*"))
                .build()
