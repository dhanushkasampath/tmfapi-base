...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CreateCustomerRespDto create(CreateCustomerReqDto createCustomerReqDto) {
        ...
        customer.setAccount(((createCustomerReqDto.getCustomer().getAccount() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(createCustomerReqDto.getCustomer().getAccount(), AccountRef[].class))));
        customer.setAgreement(((createCustomerReqDto.getCustomer().getAgreement() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(createCustomerReqDto.getCustomer().getAgreement(), AgreementRef[].class))));
        customer.setCharacteristic(((createCustomerReqDto.getCustomer().getCharacteristic() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(createCustomerReqDto.getCustomer().getCharacteristic(), Characteristic[].class))));
        customer.setPaymentMethod(((createCustomerReqDto.getCustomer().getPaymentMethod() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(createCustomerReqDto.getCustomer().getPaymentMethod(), PaymentRef[].class))));
        customer.setRelatedParty(((createCustomerReqDto.getCustomer().getRelatedParty() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(createCustomerReqDto.getCustomer().getRelatedParty(), RelatedParty[].class))));
        customer.setCreditProfile(((createCustomerReqDto.getCustomer().getCreditProfile() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(createCustomerReqDto.getCustomer().getCreditProfile(), CreditProfile[].class))));
        customer.setContactMedium(((createCustomerReqDto.getCustomer().getContactMedium() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(createCustomerReqDto.getCustomer().getContactMedium(), ContactMedium[].class))));
        customer.setEngagedParty(((createCustomerReqDto.getCustomer().getEngagedParty() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(createCustomerReqDto.getCustomer().getEngagedParty(), EngagedParty[].class))));
    ...
    public UpdateCustomerRespDto update(String id, UpdateCustomerReqDto updateCustomerReqDto) throws CustomerMgtException {
        ...
        customer.setAccount(((updateCustomerReqDto.getCustomer().getAccount() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(updateCustomerReqDto.getCustomer().getAccount(), AccountRef[].class))));
        customer.setAgreement(((updateCustomerReqDto.getCustomer().getAgreement() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(updateCustomerReqDto.getCustomer().getAgreement(), AgreementRef[].class))));
        customer.setCharacteristic(((updateCustomerReqDto.getCustomer().getCharacteristic() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(updateCustomerReqDto.getCustomer().getCharacteristic(), Characteristic[].class))));
        customer.setPaymentMethod(((updateCustomerReqDto.getCustomer().getPaymentMethod() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(updateCustomerReqDto.getCustomer().getPaymentMethod(), PaymentRef[].class))));
        customer.setRelatedParty(((updateCustomerReqDto.getCustomer().getRelatedParty() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(updateCustomerReqDto.getCustomer().getRelatedParty(), RelatedParty[].class))));
        customer.setCreditProfile(((updateCustomerReqDto.getCustomer().getCreditProfile() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(updateCustomerReqDto.getCustomer().getCreditProfile(), CreditProfile[].class))));
        customer.setContactMedium(((updateCustomerReqDto.getCustomer().getContactMedium() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(updateCustomerReqDto.getCustomer().getContactMedium(), ContactMedium[].class))));
        customer.setEngagedParty(((updateCustomerReqDto.getCustomer().getEngagedParty() == null) ? new ArrayList<>() : Arrays.asList(getModelMapper().map(updateCustomerReqDto.getCustomer().getEngagedParty(), EngagedParty[].class))));
